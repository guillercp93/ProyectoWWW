...
(function ( $ ) {
		...
		if(this.events !== undefined) {
			...
			for(var o = 0; o<ev.length;o++) {
				if (document.getElementById("p").value == "1"){
					$(".specific-day-scheme").append('<div class="specific-day-scheme-event"><h1>'+ev[o]['name']+'</h1><p data-role="dur"><a class="colorbox" href="vista/Citas.php?accion=editar&idevento='+ev[o]['idevento']+'"><img src="img/026.png"></a></p></div>');
				} else{
					$(".specific-day-scheme").append('<div class="specific-day-scheme-event"><h1>'+ev[o]['name']+'</h1><p data-role="dur"><a class="colorbox" href="vista/Citas.php?accion=editar&idevento='+ev[o]['idevento']+'"><img src="img/026.png"></a><a class="colorbox" href="vista/Citas.php?accion=eliminar&idevento='+ev[o]['idevento']+'"><img src="img/020.png"></a></p></div>');
				};
	...
	function calendarSetMonth(ele,offset) {
		...
		ele.find(".calendar-month-view p").text(monthArray[d.getMonth()][1]+' '+d.getFullYear());
			...
			for(var i=0;i<42;i++) {
				...
				if(!esFestivo((d.getMonth()+1)+'-'+d.getDate()) && d.getMonth() === e.getMonth() && d.getDay() != 0)
				{
					if(document.getElementById("p").value != "1")
						cal_day = $('<div class="calendar-day"><div class="date-holder"><a class="colorbox" href="vista/Citas.php?accion=insertar&dia='+d.getFullYear()+'-'+(d.getMonth()+1)+'-'+d.getDate()+'"><img src="img/021.png"></a>'+d.getDate()+'</div></div>');
				}else
				{
					if(d.getMonth() !== e.getMonth())
						cal_day.addClass('other-month');
					else
						cal_day.addClass('festivo');
				}
	...
	function esFestivo (date) {
		...
		switch(date)
		{
			case "1-1": return true; break;
			case "1-6": return true; break;
			case "3-24": return true; break;
			case "4-13": return true; break;
			case "4-17": return true; break;
			case "4-18": return true; break;
			case "4-20": return true; break;
			case "5-1": return true; break;
			case "6-2": return true; break;
			case "6-23": return true; break;
			case "6-30": return true; break;
			case "7-20": return true; break;
			case "8-7": return true; break;
			case "8-18": return true; break;
			case "10-13": return true; break;
			case "11-3": return true; break;
			case "11-17": return true; break;
			case "12-8": return true; break;
			case "12-25": return true; break;
